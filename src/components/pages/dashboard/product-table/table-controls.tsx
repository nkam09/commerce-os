...
export function GroupByDropdown({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-[calc(100%+4px)] z-50 min-w-[140px] rounded-lg border border-border bg-card py-1 shadow-xl animate-fade-in">
...
export function ColumnsDropdown({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-[calc(100%+4px)] z-50 w-60 rounded-lg border border-border bg-card p-3 shadow-xl animate-fade-in max-h-[400px] overflow-y-auto">
...
const CSV_COLUMNS: { header: string; accessor: (r: ProductRow) => string }[] = [
  ...
  { header: "Refunds", accessor: (r) => r.refunds.toFixed(2) },
...
export function ExportDropdown({ data }: { data: ProductRow[] }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-[calc(100%+4px)] z-50 min-w-[220px] rounded-lg border border-border bg-card py-1 shadow-xl animate-fade-in">
          <button
            type="button"
